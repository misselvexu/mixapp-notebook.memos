  ...
  return !initialized ? (
    ...
    <div className="w-full min-h-full flex flex-row justify-center items-start sm:pl-16">
      {sm && (
        <div
          className={cn(
            "group flex flex-col justify-start items-start fixed top-0 left-0 select-none border-r border-[var(--color-border)] h-full bg-[var(--color-secondary)] dark:bg-opacity-40",
            "w-16 px-2",
          )}
        >
