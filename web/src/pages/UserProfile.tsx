            ...
            <>
              ...
              <div className="w-full flex flex-col justify-start items-start pt-4 pb-8 px-3">
                ...
                <div className="mt-2 w-auto max-w-[calc(100%-6rem)] flex flex-col justify-center items-start">
                  <p className="w-full text-3xl text-black leading-tight font-medium opacity-80 dark:text-[var(--color-muted-foreground)] truncate">
                    {user.displayName || user.username}
                  </p>
                  <p className="w-full text-[var(--color-muted-foreground)] leading-snug dark:text-[var(--color-muted-foreground)] whitespace-pre-wrap truncate line-clamp-6">
                    {user.description}
                  </p>
                </div>
              </div>
