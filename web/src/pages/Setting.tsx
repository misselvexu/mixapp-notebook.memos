  ...
  return (
    <section className="@container w-full max-w-5xl min-h-full flex flex-col justify-start items-start sm:pt-3 md:pt-6 pb-8">
      ...
      <div className="w-full px-4 sm:px-6">
        <div className="w-full shadow flex flex-row justify-start items-start px-4 py-3 rounded-xl bg-white dark:bg-[var(--color-card)] text-[var(--color-muted-foreground)]">
          <div className="hidden sm:flex flex-col justify-start items-start w-40 h-auto shrink-0 py-2">
            <span className="text-sm mt-0.5 pl-3 font-mono select-none text-[var(--color-muted-foreground)]">{t("common.basic")}</span>
            ...
            {isHost ? (
              <>
                <span className="text-sm mt-4 pl-3 font-mono select-none text-[var(--color-muted-foreground)]">{t("common.admin")}</span>
                <div className="w-full flex flex-col justify-start items-start mt-1">
