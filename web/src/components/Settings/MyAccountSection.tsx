...
const MyAccountSection = () => {
  ...
  return (
    <div className="w-full gap-2 pt-2 pb-4">
      <p className="font-medium text-[var(--color-foreground)]">{t("setting.account-section.title")}</p>
      <div className="w-full mt-2 flex flex-row justify-start items-center">
        ...
        <div className="max-w-[calc(100%-3rem)] flex flex-col justify-center items-start">
          <p className="w-full">
            ...
            <span className="ml-1 text-base leading-tight text-[var(--color-muted-foreground)]">({user.username})</span>
          </p>
        ...
        <Popover>
          ...
          <PopoverContent align="start" className="text-sm p-1">
            <button
              ...
              className="w-full flex items-center gap-2 px-2 py-1 text-left text-sm hover:bg-[var(--color-secondary)] rounded-md"
            >
