...
const WorkspaceSection = observer(() => {
  ...
  return (
    <div className="w-full flex flex-col gap-2 pt-2 pb-4">
      <p className="font-medium text-[var(--color-foreground)]">{t("common.basic")}</p>
      ...
      <Separator />
      <p className="font-medium text-[var(--color-foreground)]">{t("setting.system-section.title")}</p>
      <div className="w-full flex flex-row justify-between items-center">
      ...
      <div className="w-full">
        <Link
          className="text-[var(--color-muted-foreground)] text-sm flex flex-row justify-start items-center hover:underline hover:text-blue-600"
