...
const MemberSection = observer(() => {
  ...
  return (
    <div className="w-full flex flex-col gap-2 pt-2 pb-4">
      <p className="font-medium text-[var(--color-foreground)]">{t("setting.member-section.create-a-member")}</p>
      <div className="w-auto flex flex-col justify-start items-start gap-2 border border-[var(--color-border)] rounded-md py-2 px-3 dark:border-[var(--color-border)]">
      ...
      <div className="w-full overflow-x-auto">
        <div className="inline-block min-w-full align-middle border border-[var(--color-border)] rounded-lg">
          <table className="min-w-full divide-y divide-gray-300 dark:divide-zinc-600">
            <thead>
              <tr className="text-sm font-semibold text-left text-[var(--color-foreground)] dark:text-[var(--color-muted-foreground)]">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-zinc-600">
              {sortedUsers.map((user) => (
                <tr key={user.name}>
                  ...
                  <td className="whitespace-nowrap px-3 py-2 text-sm text-[var(--color-muted-foreground)]">{user.displayName}</td>
                  <td className="whitespace-nowrap px-3 py-2 text-sm text-[var(--color-muted-foreground)]">{user.email}</td>
