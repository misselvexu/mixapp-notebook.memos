  ...
  return (
    <div className="max-w-full shadow flex flex-col justify-start items-start bg-white dark:bg-[var(--color-card)] p-4 rounded-lg">
      ...
      <div className="flex flex-col justify-start items-start w-64! space-y-2">
        ...
        <p className="text-sm">
          {t("common.username")}
          <span className="text-sm text-[var(--color-muted-foreground)] ml-1">({t("setting.account-section.username-note")})</span>
        </p>
        <Input
          className="w-full"
        ...
        <p className="text-sm">
          {t("common.nickname")}
          <span className="text-sm text-[var(--color-muted-foreground)] ml-1">({t("setting.account-section.nickname-note")})</span>
        </p>
        <Input
          className="w-full"
        ...
        <p className="text-sm">
          {t("common.email")}
          <span className="text-sm text-[var(--color-muted-foreground)] ml-1">({t("setting.account-section.email-note")})</span>
        </p>
