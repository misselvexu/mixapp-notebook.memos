        ...
        <div className="w-full flex flex-row gap-2 mt-2 flex-wrap">
          {referencingMemoList.map((memo) => {
            return (
              <div
                key={memo.name}
                className="w-auto max-w-xs overflow-hidden flex flex-row justify-start items-center bg-[var(--color-secondary)] hover:opacity-80 rounded-md text-sm p-1 px-2 text-[var(--color-muted-foreground)] cursor-pointer hover:line-through"
