...
const CodeBlock: React.FC<Props> = ({ language, content }: Props) => {
  ...
  return (
    <div className="w-full my-1 bg-amber-100 border-l-4 border-amber-400 rounded hover:shadow relative">
      <div className="w-full px-2 py-1 flex flex-row justify-between items-center text-amber-500 dark:text-[var(--color-muted-foreground)]">
      ...
      <div className="overflow-auto">
        <pre className={cn("no-wrap overflow-auto", "w-full p-2 bg-amber-50 dark:bg-[var(--color-card)] relative")}>
          <code
